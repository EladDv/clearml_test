...
parser.add_argument('--netG', default='', help="path to netG (to continue trcaining)")
...
for epoch in range(1):
    for i, data in enumerate(dataloader, 0):
        ...
        writer.add_scalar('Loss/D', errD.data, niter)
        writer.add_scalar('Loss/G', errG.data, niter)
